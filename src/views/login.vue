...
<body class="bg-gray-800">
    ...
    <div class="relative z-10 bg-white bg-opacity-100 p-8 rounded-lg shadow-md w-full max-w-md">
      ...
      <div class="flex justify-center mb-4">
        <img :src="logo_rsi_banjarmasin.png") }}" alt="Logo" class="h-16 w-16 rounded-full border">
      </div>
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="email" name="email" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
...
import bg_apotik.jpg from "@/assets/images/bg-apotik.jpg"
