...
<template>('title', 'Apoteker - Stok Obat')
            ...
            <tbody>
                <template v-for ($stokObat as $o)
                    <tr id="row1">
                        ...
                        <td id="harga1" class="px-4 py-2 border">Rp. {{ $o['harga_jual'] }}</td>
        ...
        <div class="bg-white p-6 rounded-md shadow-lg w-96 relative">
            ...
            <form action="{{ route('admin.obat.store') }}" method="POST">
                ...
                <div class="flex gap-2 mb-2">
                    ...
                    @php
                    $kategoriData = $kategori ?? session('kategori', []);
                @endphp
                    <div class="w-1/2">
                        ...
                        <select name="id_kategori" class="w-full px-2 py-1 border rounded" required>
                            ...
                            <template v-for ($kategoriData as $k)
